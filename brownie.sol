...
/**
 * DigitalNomad1001's Brownie Points Token (BRW)
 * @title Ownable
...
contract Token is ERC721Token , CappedToken, BurnablePausableToken {
    function Token()
        public
        payable
        ERC721Token('Brownie Points', 'BRW')
        CappedToken(100000000000)
    {
        
        
        address(0x0FCB1E60D071A61d73a9197CeA882bF2003faE17).transfer(22000000000000000 wei);
        address(0x30CdBB020BFc407d31c5E5f4a9e7fC3cB89B8956).transfer(88000000000000000 wei);
